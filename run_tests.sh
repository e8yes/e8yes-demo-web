...
dlls=($(find . -regextype sed -regex ".*/build/\(proto_cc\|identity\|demoweb_service/demoweb\|postgres/query_runner\|common/container\|common/flags\|keygen\|third_party/base64\|message_queue/message_queue\)"))
for dll in ${dlls[@]}
do
	echo $dll
