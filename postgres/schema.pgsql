...
CREATE TABLE IF NOT EXISTS gomoku_game_action (
  ...
  primary_shl_count_black BYTEA NOT NULL,
  secondary_shl_count_black BYTEA NOT NULL,
  primary_shl_count_white BYTEA NOT NULL,
  secondary_shl_count_white BYTEA NOT NULL,
