...
std::map<std::string, e8::NodeState> PrepareNodeStates() {
    ...
    (*node1.mutable_ip_address()) += 1_uchar;
    node1.mutable_types()->Add(e8::NDT_FILE_STORE);
    ...
    node2.mutable_types()->Add(e8::NDT_TASK_EXECUTOR);
    node2.mutable_types()->Add(e8::NDT_MESSAGE_STORE);
...
void node_state_store_test::update_and_load_test() {
    ...
    e8::NodeStateWriterStore writer_store(/*file_path=*/"test.sqlite", /*override_data=*/true);
