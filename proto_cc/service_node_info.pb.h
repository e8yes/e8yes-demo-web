...
#ifndef PROTOBUF_INCLUDED_service_5fnode_5finfo_2eproto
#define PROTOBUF_INCLUDED_service_5fnode_5finfo_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_service_5fnode_5finfo_2eproto 
...
class UpdateNodeStateRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:e8.UpdateNodeStateRequest) */ {
 public:
  ...
  ::e8::Node* mutable_nodes(int index);
  ::google::protobuf::RepeatedPtrField< ::e8::Node >*
      mutable_nodes();
  const ::e8::Node& nodes(int index) const;
  ::e8::Node* add_nodes();
  const ::google::protobuf::RepeatedPtrField< ::e8::Node >&
      nodes() const;
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::e8::Node > nodes_;
  mutable ::google::protobuf::internal::CachedSize _cached_size_;
  friend struct ::protobuf_service_5fnode_5finfo_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#endif  // PROTOBUF_INCLUDED_service_5fnode_5finfo_2eproto
