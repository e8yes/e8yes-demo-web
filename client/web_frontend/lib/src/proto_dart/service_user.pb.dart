...
class AuthorizationResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('AuthorizationResponse', package: const $pb.PackageName('e8'), createEmptyInstance: create)
    ..aOM<$18.IdentitySignature>(1, 'signedIdentity', subBuilder: $18.IdentitySignature.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $18.IdentitySignature get signedIdentity => $_getN(0);
  @$pb.TagNumber(1)
  set signedIdentity($18.IdentitySignature v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSignedIdentity() => $_has(0);
  @$pb.TagNumber(1)
  void clearSignedIdentity() => clearField(1);
  @$pb.TagNumber(1)
  $18.IdentitySignature ensureSignedIdentity() => $_ensure(0);
}
...
class GetPublicProfileResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetPublicProfileResponse', package: const $pb.PackageName('e8'), createEmptyInstance: create)
    ..aOM<$13.UserPublicProfile>(1, 'profile', subBuilder: $13.UserPublicProfile.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  $13.UserPublicProfile get profile => $_getN(0);
  @$pb.TagNumber(1)
  set profile($13.UserPublicProfile v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasProfile() => $_has(0);
  @$pb.TagNumber(1)
  void clearProfile() => clearField(1);
  @$pb.TagNumber(1)
  $13.UserPublicProfile ensureProfile() => $_ensure(0);
}
...
class UpdatePublicProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('UpdatePublicProfileRequest', package: const $pb.PackageName('e8'), createEmptyInstance: create)
    ...
    ..aOM<$11.NullableString>(2, 'biography', subBuilder: $11.NullableString.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $11.NullableString get biography => $_getN(1);
  @$pb.TagNumber(2)
  set biography($11.NullableString v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBiography() => $_has(1);
  @$pb.TagNumber(2)
  void clearBiography() => clearField(2);
  @$pb.TagNumber(2)
  $11.NullableString ensureBiography() => $_ensure(1);
}
