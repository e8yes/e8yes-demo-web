...
import 'user_relation.pbenum.dart' as $13;
...
class GetUserRelationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetUserRelationsResponse', package: const $pb.PackageName('e8'), createEmptyInstance: create)
    ...
    ..pc<$13.UserRelationRecord>(3, 'userRelations', $pb.PbFieldType.PM, subBuilder: $13.UserRelationRecord.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.List<$13.UserRelationRecord> get userRelations => $_getList(2);
}
...
class GetRelatedUserListRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetRelatedUserListRequest', package: const $pb.PackageName('e8'), createEmptyInstance: create)
    ...
    ..pc<$13.UserRelation>(2, 'relationFilter', $pb.PbFieldType.PE, valueOf: $13.UserRelation.valueOf, enumValues: $13.UserRelation.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  $core.List<$13.UserRelation> get relationFilter => $_getList(1);
}
