...
SUBDIRS = \
        ...
        _test_agent/_test_heuristics/_test_model_based_evaluator/_test_model_based_evaluator.pro \
        _test_agent/_test_heuristics/_test_tfmodel_based_evaluator/_test_tfmodel_based_evaluator.pro \
