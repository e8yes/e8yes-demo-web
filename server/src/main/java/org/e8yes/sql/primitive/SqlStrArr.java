...
/** String array primitive type. */
public class SqlStrArr implements SqlPrimitiveInterface {
  private String[] val;

  public SqlStrArr() {}

  public SqlStrArr(String[] val) {
    this.val = val;
  }
  ...
  public boolean equals(Object obj) {
    return Arrays.equals(val, ((SqlStrArr) obj).val);
  }
