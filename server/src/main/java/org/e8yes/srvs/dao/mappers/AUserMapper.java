...
public interface AUserMapper {
  ...
  public EtUser loadByIdOrUserName(@Param("id") Long id, @Param("userName") String userName);
  ...
  @Select(
      "SELECT "
          ...
          + "WHERE "
          + "     u.id = #{id} OR u.user_name = #{userName} ")
  public boolean existsByIdOrUserName(@Param("id") Long id, @Param("userName") String userName);
}
