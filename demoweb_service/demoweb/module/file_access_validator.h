 ...
 * location.
 *
 * @param viewer_id ID of the user who is allowed to use this token.
 ...
 *
 * @param viewer_id ID of the viewer to validate against.
 ...
 *
 * @param viewer Identity of the user identity to be checked against.
