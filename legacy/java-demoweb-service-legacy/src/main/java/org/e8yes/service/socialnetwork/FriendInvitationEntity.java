...
/** Java class representation of the database table "friend_invitation" */
public class FriendInvitationEntity {
  public SqlLong inviter_user_id = new SqlLong();
  public SqlLong invitee_user_id = new SqlLong();
  public SqlInt status = new SqlInt();
