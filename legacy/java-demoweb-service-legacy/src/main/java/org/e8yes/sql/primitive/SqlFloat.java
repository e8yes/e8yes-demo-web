...
public class SqlFloat implements SqlPrimitiveInterface {
  private Float val;
  ...
  public void exportValueToStatement(PreparedStatement stmt, int position, Connection conn)
      throws SQLException {
    if (val != null) {
      stmt.setFloat(position, val);
    } else {
      stmt.setNull(position, java.sql.Types.FLOAT);
    }
  }
  ...
  public boolean equals(Object obj) {
    return val.equals(((SqlFloat) obj).val);
  }
