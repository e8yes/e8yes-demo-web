...
/** Integer array primitive type. */
public class SqlIntArr implements SqlPrimitiveInterface {
  private Integer[] val;

  public SqlIntArr() {}

  public SqlIntArr(Integer[] val) {
    this.val = val;
  }
  ...
  public void exportValueToStatement(PreparedStatement stmt, int position, Connection conn)
      throws SQLException {
    if (val != null) {
      stmt.setArray(position, conn.createArrayOf("INT", val));
    } else {
  ...
  public boolean equals(Object obj) {
    return Arrays.equals(val, ((SqlIntArr) obj).val);
  }
